...
let tectonic_url = 'https://raw.githubusercontent.com/fraxen/tectonicplates/b53c3b7d82afd764650ebdc4565b9666795b9d83/GeoJSON/PB2002_boundaries.json'
...
d3.json(earthquake_url, function(response){
    ...
    for (let i = 0; i < response.features.length; i++) {
        ...
        min = (min < 10 ? "0" : "") + min;
        sec = (sec < 10 ? "0" : "") + sec;    
        let formattedDate = date.getFullYear() + "-" + month + "-" + day + " " +  hour + ":" + min + ":" + sec;
        ...
        }).bindPopup("<h2>" + prop.place + "</h2> <hr> <h3>Date: " + formattedDate + "</h3> <hr> <h3>Magnitude: " + prop.mag + "</h3>")
        .addTo(earthquakes);
    ...
    //Adding slider for the earthquake data
    let sliderControl = L.control.sliderControl({position: "topright", layer: earthquakes, follow: 10});
